defmodule CLITest do
  ...
  test "three values returned if three given" do
    ...
    assert parse_args(["-h", "user", "project", "99"]) == {"user", "project", 99}
  end
  ...
  # test "value of man switch is given" do
  #   assert parse_args(["--man", "my Man"]) == "my Man"
  #   assert parse_args(["-m", "man as shortcut"]) == "man as shortcut"
  # end
